...
def get_colors():
	...
	SPECIAL = {
		...
		FILE		: color_char(8,-1,0xE612),		# Normal file, or one that does not have a color associated with it.
		DIRECTORY	: color_char(3,-1,0xE5FE),		# A folder.
		...
		EXEC		: color_char(13,-1,0xF292),		# An executable file.
	...
	EXTENSION_LIST = {
		...
		"*rc":			cc(242, -1, 0xF0AD),
		".ini":			cc(242, -1, 0xF0AD),
		"*conf":		cc(242, -1, 0xF0AD),
		".viminfo":		cc(242, -1, 0xF0AD),
		".pcf":			cc(242, -1, 0xF0AD),
		".psf":			cc(242, -1, 0xF0AD),
		".git":			cc(197, -1, 0xE702),
