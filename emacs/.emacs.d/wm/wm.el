...
(define-minor-mode wm-mode
  ...
  :keymap (let ((keymap (make-sparse-keymap)))
	    ...
	    (define-key keymap (kbd "M-=") 'wm-push-window)
	    (define-key keymap (kbd "C-+") 'wm-insert-window)
	    (define-key keymap (kbd "M--") 'wm-pop-window)
	    (define-key keymap (kbd "C-_") 'wm-delete-next-window)
	    (define-key keymap (kbd "M-q") 'wm-delete-window)
	    (define-key keymap (kbd "M-[") 'wm-move-window-backward)
	    (define-key keymap (kbd "M-]") 'wm-move-window-forward)
	    ;(define-key keymap (kbd "M-[") 'wm-move-window-to-front)
	    ;(define-key keymap (kbd "M-]") 'wm-move-window-to-back)
	    (define-key keymap (kbd "M-'") 'wm-focus-next-window)
	    (define-key keymap (kbd "M-;") 'wm-focus-previous-window)
	    ...
	    (define-key keymap (kbd "C-1") (lambda () (interactive) (wm-switch-workspace 0)))
	    (define-key keymap (kbd "C-2") (lambda () (interactive) (wm-switch-workspace 1)))
	    (define-key keymap (kbd "C-3") (lambda () (interactive) (wm-switch-workspace 2)))
	    (define-key keymap (kbd "C-4") (lambda () (interactive) (wm-switch-workspace 3)))
	    keymap)
  (wm-manage-windows))

(provide 'wm)
;;; wm.el ends here<Paste>
